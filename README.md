...
Note: Add Route will sometimes crash the server/corrupt files. I left it in for testing purposes but if a route is added/had it's name changed it will be updated in the Database when Store all files is ran.
